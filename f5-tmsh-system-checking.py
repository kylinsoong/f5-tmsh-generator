...
results.extend(checking03.checking("config/sys-availability"))
results.extend(checking04.checking("config/sys-software"))
results.extend(checking06.checking("config/sys-clock"))
results.extend(checking07.checking("config/sys-license"))
results.extend(checking08.checking("config/sys-cpu"))
results.extend(checking09.checking("config/sys-memory"))
...
results.extend(checking14.checking("config/df-h"))
results.extend(checking15.checking("config/net-interface"))
results.extend(checking16.checking("config/sys-failover"))
results.extend(checking17.checking("config/sys-performance"))
results.extend(checking18.checking("config/sys-performance"))
results.extend(checking19.checking("config/sys-performance"))
results.extend(checking20.checking("config/net-vlan-failsafe"))
results.extend(checking21.checking("config/cm-sync-status"))
results.extend(checking22.checking("config/ltm-virtual"))
results.extend(checking23.checking("config/net-interface"))
